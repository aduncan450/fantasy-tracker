...
test('public redesign keeps the dashboard compact and status-localized',async({page})=>{
  ...
  await expect(page.locator('#season-context')).toHaveText(/2026–2027 SEASON \| WEEK 1/);
...
test('completed matchup styling keeps winner and loser cues distinct',async({page})=>{
  const production=initialLeague();
